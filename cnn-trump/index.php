...
<body>
    ...
    <p>Trump and CNN often use langauge that indicates negative emotions toward each other. This can be analyzed using <a href="https://aylien.com/"  target="_blank">Aylien</a>, a sentiment analysis program based on natural language.</p>
    ...
    <p>If Trump mentioned "CNN" in his last 50 tweets from his personal account (<a href="https://twitter.com/realDonaldTrump"  target="_blank">@realDonaldTrump</a>), they'll populate below with sentiment analysis.</p>
    ...
    $getfield = '?screen_name=realDonaldTrump&count=100&tweet_mode=extended';
    $requestMethod = 'GET';
    ...
    <p>On the flipside, if CNN mentioned "Trump" in their last 30 tweets from their main account (<a href="https://twitter.com/CNN"  target="_blank">@CNN</a>), they'll populate below with sentiment analysis.</p>
    ...
    $url = 'https://api.twitter.com/1.1/statuses/user_timeline.json';
    $getfield = '?screen_name=CNN&count=30&tweet_mode=extended';
    $requestMethod = 'GET';
    $twitter = new TwitterAPIExchange($settings);
    $tweetData = json_decode( $twitter->setGetfield($getfield)
                 ->buildOauth($url, $requestMethod)
    ...
    echo '</div>';
    echo '<i class="polarized-subtext">*There are currently <b>'.$polarizedCount.'</b> of these tweets displayed.</i>';
